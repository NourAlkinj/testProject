        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex">
                    ...
                    <a href="{{ route('invoice.index') }}" class="btn btn-primary ml-auto"><i class="fa fa-home"></i> {{ __('Frontend/product.back_to_invoice') }}</a>
                </div>
                ...
                <div class="card-body">
                    <form action="{{ route('invoice.update', $invoice->id) }}" method="post" class="form">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="customer_name">{{ __('Frontend/product.customer_name') }}</label>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="customer_email">{{ __('Frontend/product.customer_email') }}</label>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="customer_mobile">{{ __('Frontend/product.customer_mobile') }}</label>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="company_name">{{ __('Frontend/product.company_name') }}</label>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="invoice_number">{{ __('Frontend/product.invoice_number') }}</label>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="invoice_date">{{ __('Frontend/product.invoice_date') }}</label>
                        ...
                        <div class="table-responsive">
                            <table class="table" id="invoice_details">
                                ...
                                <tr class="cloning_row" id="{{ $loop->index }}">
                                    ...
                                    <td>
                                        <select name="unit[{{ $loop->index }}]" id="unit" class="unit form-control">
                                            <option></option>
                                            <option value="piece" {{ $item->unit == 'piece' ? 'selected' : '' }}>{{ __('Frontend/product.piece') }}</option>
                                            <option value="g" {{ $item->unit == 'g' ? 'selected' : '' }}>{{ __('Frontend/product.gram') }}</option>
                                            <option value="kg" {{ $item->unit == 'kg' ? 'selected' : '' }}>{{ __('Frontend/product.kilo_gram') }}</option>
                                        </select>
                                ...
                                <tr>
                                    <td colspan="6">
                                        <button type="button" class="btn_add btn btn-primary">{{ __('Frontend/product.add_another_product') }}</button>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3"></td>
                                    <td colspan="2">{{ __('Frontend/product.sub_total') }}</td>
                                ...
                                <tr>
                                    <td colspan="3"></td>
                                    <td colspan="2">{{ __('Frontend/product.discount') }}</td>
                                    <td>
                                        <div class="input-group mb-3">
                                            <select name="discount_type" id="discount_type" class="discount_type custom-select">
                                                <option value="fixed" {{ $invoice->discount_type == 'fixed' ? 'selected' : '' }}>{{ __('Frontend/product.sr') }}</option>
                                                <option value="percentage" {{ $invoice->discount_type == 'percentage' ? 'selected' : '' }}>{{ __('Frontend/product.percentage') }}</option>
                                            </select>
                                ...
                                <tr>
                                    <td colspan="3"></td>
                                    <td colspan="2">{{ __('Frontend/product.vat') }}</td>
                                ...
                                <tr>
                                    <td colspan="3"></td>
                                    <td colspan="2">{{ __('Frontend/product.shipping') }}</td>
                                ...
                                <tr>
                                    <td colspan="3"></td>
                                    <td colspan="2">{{ __('Frontend/product.total_due') }}</td>
                        ...
                        <div class="text-right pt-3">
                            <button type="submit" name="save" class="btn btn-primary">{{ __('Frontend/product.update') }}</button>
                        </div>
                    </form>
                </div>
            </div>
